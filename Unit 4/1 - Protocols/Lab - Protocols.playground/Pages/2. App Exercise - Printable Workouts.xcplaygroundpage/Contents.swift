 ...
 */
var myThiredWorkout = Workout(distance: 300, time: 35, identifier: 3)
...
var myArrayOfWorkouts: [Workout] = [myFourthWorkout, mySecondWorkout, myFirstWorkout, myFifthWorkout, myThiredWorkout]
...
let myData = try! myEncoder.encode(myThiredWorkout)
