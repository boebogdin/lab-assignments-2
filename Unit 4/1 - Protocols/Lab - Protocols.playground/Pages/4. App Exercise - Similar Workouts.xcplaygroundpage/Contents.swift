...
var myRunning = RunningWorkout(distance: 1_000, time: 100)
var mySwimming = SwimmingWorkout(distance: 2_000, time: 500)
...
simpleWorkoutDescription(workout: myRunning)
simpleWorkoutDescription(workout: mySwimming)
/*:
